 (function(window) {
    ...
    PageManager.prototype = {
        ...
        saveFunction : function(evt) {
            ...
            setTimeout((function(){
                $(elem).removeClass("curr");  
                var car1 = document.getElementById("car");       //品牌
                var car2 = document.getElementById("car2");  //型号                  
                var car3 = document.getElementById("car3");  //排量
                var brand = "品牌:"+car1.options[car1.selectedIndex].innerHTML+",型号:"+car2.value+",排量:"+car3.options[car3.selectedIndex].innerHTML
                // alert(brand);
                var fromSource = {"brand" : brand}
                var fromSourceStr = Trafficeye.json2Str(fromSource);
                Trafficeye.offlineStore.set("survey_brand", fromSourceStr);
