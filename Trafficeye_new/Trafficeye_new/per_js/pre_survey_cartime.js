 (function(window) {
    ...
    PageManager.prototype = {
        ...
        infoabtnUp : function(evt) {
            ...
            var fromSource = {"cartime" : "A"}
            var fromSourceStr = Trafficeye.json2Str(fromSource);
            Trafficeye.offlineStore.set("survey_cartime", fromSourceStr);
        },
        ...
        saveFunction : function(evt) {
            ...
            setTimeout((function(){
                $(elem).removeClass("curr");  
                var cartime = Trafficeye.offlineStore.get("survey_cartime");
                var prize = Trafficeye.str2Json(cartime);
