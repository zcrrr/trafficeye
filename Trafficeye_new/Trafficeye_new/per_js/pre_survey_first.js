    ...
    PageManager.prototype = {
        ...
        saveFunction : function(evt) {
            ...
            setTimeout((function(){
                ...
                var fromSource = {"licenseTime" : textNickname}
                var fromSourceStr = Trafficeye.json2Str(fromSource);
                Trafficeye.offlineStore.set("survey_licenseTime", fromSourceStr);
                ...
                "brand" : "",
                "buyTime" : "",
                "licenseTime" : textNickname
                };
                me.saveNameFunction(url,data);
            }),Trafficeye.MaskTimeOut);     
        },
        /**
         * 用户信息修改请求函数
         */
        saveNameFunction : function(url,data) {
            var me = this;
...
//                                console.log(dataReward);
    ...
    $(function(){
        ...
        pm.init();
                //判断缓存中是否有userinfo信息
        if(myInfo.userinfo){
            var survey_licenseTime = Trafficeye.offlineStore.get("survey_licenseTime");
            // if(survey_licenseTime){
            //     var dataStr = Trafficeye.str2Json(survey_licenseTime);
            //     document.getElementById("inputValue").value=dataStr.licenseTime;
            // }
            Trafficeye.offlineStore.set("traffic_infosurveycar","survey");
        }else{
            //让用户重新登录
