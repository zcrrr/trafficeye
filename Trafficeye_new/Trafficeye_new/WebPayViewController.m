...
- (void)viewDidLoad
{
    ...
    NSString* str_url = [NSString stringWithFormat:@"http://mobile.trafficeye.com.cn:8090/AlipayService/WAPPay?out_trade_no=%@&subject=%@&body=%@&total_fee=%@",self.orderid,@"路况交通眼商品",@"路况交通眼商品描述",self.totalCost];
    str_url = (NSString *)CFURLCreateStringByAddingPercentEscapes(kCFAllocatorDefault, (CFStringRef)str_url, nil, nil, kCFStringEncodingUTF8);
...
- (void)viewDidAppear:(BOOL)animated{
    ...
    NSString *logString = [NSString stringWithFormat:@"%li,%@,%f %f;",
                           [TEUtil getNowTime],
                           [NSString stringWithFormat:@"I%@201104",LOG_VERSION],
