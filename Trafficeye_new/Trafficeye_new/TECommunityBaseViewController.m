//
//  TECommunityBaseViewController.m
//  Trafficeye_new
//
...
@interface TECommunityBaseViewController ()

@end

@implementation TECommunityBaseViewController
...
- (void)viewDidAppear:(BOOL)animated{
    ...
    UIView *view_toolbar = [[UIView alloc]initWithFrame:CGRectMake(0, y_toolbar, 320, 45)];
    view_toolbar.backgroundColor = [[UIColor whiteColor] colorWithAlphaComponent:0.7];
    ...
    [view_toolbar addSubview:button_report];
}
