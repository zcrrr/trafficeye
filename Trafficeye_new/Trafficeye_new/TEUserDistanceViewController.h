//
//  TEUserDistanceViewController.h
//  Trafficeye_new
//
...
@interface TEUserDistanceViewController : TESecondLevelViewController<UserDistanceDetailDelegate,UIScrollViewDelegate>
...
@property (strong, nonatomic) IBOutlet UILabel *label_track;
